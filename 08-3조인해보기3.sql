...
/*조인결과가있어야 부서명만 뽑아서 출력을 할 수가 있으니..*/
...
SELECT e.employee_id, e.first_name, e.salary, d.department_name, loc.city
...
SELECT e1.employee_id, e1.first_name, e1.manager_id, e2.first_name, e2.salary
FROM employees e1
